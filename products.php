    ...
    <div class="row">
        ...
        while($row=mysqli_fetch_assoc($result))
        {
          echo '<div class="col-md-3">
                  <div class="product-tab">
                    ...
                    <p class="justify titit"><b><i> &nbsp&nbsp&nbsp&nbsp '.$row['product_description'].'</i></b></p>
      ...
      <div class="container">
        ...
        <?php 
          ...
          {
            echo '<div class="col-md-2 tol">
                    <div class="row hover-pink mx-5 ol">
                      
                      <div class="col-md-5 mx-5">
                        <a href="product_description.php?product_id='.$row1['product_id'].'">
                        <img src="images/'.$row1['product_image'].'" class="img-size-xs foto">
                        </a>
                      </div>
