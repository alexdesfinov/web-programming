    ...
    <div class="row">
      <?php 
        ...
        { 
          if ($_GET['msg']==1)
          {
            echo 'Pesanan Anda Telah Dibatalkan<br>';
          }
          elseif($_GET['msg']==2)
          {
            echo "Pesanan Anda Tidak Dapat Dibatalkan";
          }
          else
          {
        ...
        while($row=mysqli_fetch_assoc($result))
        {
          echo '<div class="col-md-3">
                  <div class="product-tab">
                    ...
                    <a href="delete_from_order.php?product_id='.$row['product_id'].'" class="btn btn-block btn-danger" >Batalkan Pesanan</a>                    
                  </div>
                </div>';
        }
?>